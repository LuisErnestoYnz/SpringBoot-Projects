...
*/
@Component("pagoTDC")
public class PagoTDC implements MetodosDePago {
	@Override
	public boolean procesarPago(double cantidad) {
		if(cantidad > 0) {
			System.out.println("Pago de $"+ cantidad + " efectuado con Tarjeta de Crédito.");
			return true;          // Ya que el pago será valido
		} else {
			System.out.println("Antención: ¡Error de pago con Tarjeta de Crédito!. Monto no válido.");
